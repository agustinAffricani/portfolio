    ...
    <main class="container">
        ...
        <div class="row proyecto">
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 p-0">
                        <img src="images/abmclientes.png" alt="" class="img-thumbnail">
                    </div>
            ...
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 p-0">
                        <img src="images/abmventas.png" alt="" class="img-thumbnail">
                    </div>
                    <div class="col-12 py-3 color-gradiente">
            ...
            <div class="col-sm-4 col-12 p-sm-4 px-4 py-2">
                <div class="row card">
                    <div class="col-12 p-0">
                        <img src="images/proyecto-integrador.png" alt="" class="img-thumbnail">
                    </div>
                    <div class="col-12 py-3 color-gradiente">
